...
pub struct Configuration {
  ...
  #[serde(rename = "jsxAttributes.spaceSurroundingExpression")]
  pub jsx_attributes_space_surrounding_expression: bool,
  #[serde(rename = "jsxChild.spaceSurroundingExpression")]
  pub jsx_child_space_surrounding_expression: bool,
